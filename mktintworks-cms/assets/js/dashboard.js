window.MKT_CMS_UI.mountDashboardPage({
  ...
  modules: [
    ...
    { href: "/pages/blog-editor.html", label: "Blog Editor", summary: "Article assembly and preview workflow.", status: "Queued" },
    { href: "/pages/testimonials.html", label: "Testimonials", summary: "Moderation queue and approvals.", status: "Queued" },
    ...
    { href: "/pages/invoices.html", label: "Invoices", summary: "Commercial billing document flow.", status: "Queued" },
    { href: "/pages/warranty.html", label: "Warranty", summary: "Coverage records and issue flows.", status: "Queued" },
    { href: "/pages/records.html", label: "Records", summary: "Client, vehicle, and install history.", status: "Live" },
    { href: "/pages/sales.html", label: "Sales", summary: "Lead pipeline and close momentum.", status: "Live" },
  ],
  spotlights: [
    {
      type: "checklist",
